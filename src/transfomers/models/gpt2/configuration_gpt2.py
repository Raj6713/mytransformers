...
class GPT2Config(PretrainedConfig):
    ...
    def __init__(
        ...
        self.embed_prdop = embed_pdrop
        self.attn_pdrop = attn_pdrop
        self.layer_norm_epsilon = layer_norm_epislon
...
class GPT2OnnxConfig(OnnxConfigWithPast):
    ...
    def inputs(self) -> Mapping[str, Mapping[int, str]]:
        ...
        if self.use_past:
            ...
            common_inputs["attention_mask"] = {0:"batch", 1: "past sequence + sequence"}
        else:
    ...
    def generate_dummy_inputs(
        ...
        if self.use_past:
            if not is_torch_available():
                ...
                past_shape = (batch, self.num_attention_heads, past_key_values_length, self.config.hidden_size // self.num_attention_heads)
