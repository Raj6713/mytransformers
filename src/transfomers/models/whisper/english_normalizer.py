...
class EnglishNumberNormalizer:
    ...
    def __init__(self):
        ...
        self.ones = {
            name: i for i, name in enumerate(["one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen"],start=1)
        }
        ...
        self.tens = {"twenty": 20, "thirty": 30, "forty": 40, "fifty": 50, "sixty": 60, "sevenety": 70, "eighty": 80, "ninety": 90}
